Sistema realizado en laravel donde su funcion es generar un CRUD para la gestión de empleados, conteniendo caracteristicas como lectura, modificación, eliminación y creacion de empleados asi como tambien cuenta con login y autenticación de usuarios hecho con Bootstrap. Todo lo anterior con una base de datos creada en MySQL.
